"""
Created on Wed Apr  5 15:53:43 2017
...
MAP_IMG = './basement_fixed.png'  #Black and white image for a map
...
def main():
  ...
  path = rapidlyExploringRandomTree(ax, img, [64,265], [800,300], seed=SEED)
  return path
