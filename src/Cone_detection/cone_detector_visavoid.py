...
class Pursuit_Detector:
    ...
    def processImage(self, image_msg):
        ...
        try:
            ...
            # controlMsg.data = [worldx*self.ft_to_m, worldy*self.ft_to_mss, cone_color]
            # 1 for green 0 for orange
            controlMsg.data = [shift, h, cone_color]
...
if __name__=="__main__":
    ...
    rospy.init_node('Pursuit_Detector')
