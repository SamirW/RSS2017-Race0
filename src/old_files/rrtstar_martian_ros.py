...
class RRT(object):
    def __init__(self):
        ...
        self.pub_path = rospy.Publisher(rospy.get_param("~path_topic", "/path"), Float32MultiArray, queue_size=1)
        ...
        # Load and store map #
        self.map_loc = "/home/racecar/racecar-ws/src/lab6/maps/basement_fixed_more_dilated3.png"
        self.map_img = imread("/home/racecar/racecar-ws/src/lab6/maps/basement_fixed_more_dilated3.png")
